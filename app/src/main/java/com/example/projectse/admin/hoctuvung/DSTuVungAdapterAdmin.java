...
public class DSTuVungAdapterAdmin extends BaseAdapter {
    private Context context;
    private int layout;
    private List<TuVung> dstuvungs;
    private IonClickItemVocab ionClickItemVocab;

    public DSTuVungAdapterAdmin(Context context, int layout, List<TuVung> dstuvungs, IonClickItemVocab ionClickItemVocab) {
