package com.example.projectse.user.dienkhuyet;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.urlGetUnitCategory, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    boHocTapAdapter =new BoHocTapAdapter(DienKhuyetActivity.this,R.layout.row_bo, boHocTapArrayList);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("idSubjectCategory", String.valueOf(5));
                return param;
            }
        };
